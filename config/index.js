...
module.exports = {
  ...
  build: {
    ...
    index: path.resolve(__dirname, process.env.IS_DOCKER == "yes" ?  '../../dist/index.html' : '../dist/index.html'),

    // Paths
    assetsRoot: path.resolve(__dirname, process.env.IS_DOCKER == "yes" ? '../../dist' : "../dist"),
    assetsSubDirectory: 'static',
